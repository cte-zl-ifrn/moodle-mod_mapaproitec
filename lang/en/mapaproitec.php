...
$string['modulename'] = 'Mapa Proitec';
$string['modulename_help'] = 'Use the newmodule module for...';
$string['modulenameplural'] = 'Mapa Proitec';
$string['mapaproitec:addinstance'] = 'Add instance';
$string['mapaproitecfieldset'] = 'Mapa Proitec fieldset';
$string['mapaproitecname'] = 'Mapa Proitec';
$string['mapaproitecname_help'] = 'Mapa Proitec';
$string['mapaproitecsettings'] = 'Mapa Proitec settings';
...
$string['nomapaproitecinstances'] = 'Mapa Proitec instances';
$string['nonewmodules'] = 'No newmodules';
$string['pluginadministration'] = 'newmodule administration';
$string['pluginname'] = 'Mapa Proitec';
$string['privacy:metadata'] = 'Mapa Proitec does not store any personal data';
$string['view'] = 'View';
