...
/**
 * The main mod_mapaproitec configuration form.
 *
 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_mapaproitec_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('mapaproitecname', 'mod_mapaproitec'), ['size' => '64']);
        ...
        $mform->addHelpButton('name', 'mapaproitecname', 'mod_mapaproitec');
